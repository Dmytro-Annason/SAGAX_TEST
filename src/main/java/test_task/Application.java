...
public class Application implements CommandLineRunner {
    ...
    public void run(String... args) {
        fillDatabase();
        log.info("0.1 Get all employee");
        outputResult(employeeService.findAll());

        log.info("0.2 Get all departments");
        outputDepartment(departmentService.findAll());
    ...
    private void outputDepartment(List<Department> departmentList){
        departmentList.forEach(department -> log.info(department.toString()));
    }
